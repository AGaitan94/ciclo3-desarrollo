...
public class ProductoLogicServiceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			pdto.setCantidadDisponible(generateRandom(Integer.class));
			pdto.setCantidadEnProceso(generateRandom(Integer.class));
			pdto.setTiempoEspera(generateRandom(Integer.class));
			pdto.setCantidadMinima(generateRandom(Integer.class));
			pdto.setCantidadMaxima(generateRandom(Integer.class));
	...
	public void createProductoTest(){
		...
		ldto.setCantidadDisponible(generateRandom(Integer.class));
		ldto.setCantidadEnProceso(generateRandom(Integer.class));
		ldto.setTiempoEspera(generateRandom(Integer.class));
		ldto.setCantidadMinima(generateRandom(Integer.class));
		ldto.setCantidadMaxima(generateRandom(Integer.class));
		...
		Assert.assertEquals(ldto.getCantidadDisponible(), pdto.getCantidadDisponible());	
		Assert.assertEquals(ldto.getCantidadEnProceso(), pdto.getCantidadEnProceso());	
		Assert.assertEquals(ldto.getTiempoEspera(), pdto.getTiempoEspera());	
		Assert.assertEquals(ldto.getCantidadMinima(), pdto.getCantidadMinima());	
		Assert.assertEquals(ldto.getCantidadMaxima(), pdto.getCantidadMaxima());	
	}
	...
	public void getProductoTest(){
		...
		Assert.assertEquals(pdto.getCantidadDisponible(), ldto.getCantidadDisponible());
		Assert.assertEquals(pdto.getCantidadEnProceso(), ldto.getCantidadEnProceso());
		Assert.assertEquals(pdto.getTiempoEspera(), ldto.getTiempoEspera());
		Assert.assertEquals(pdto.getCantidadMinima(), ldto.getCantidadMinima());
		Assert.assertEquals(pdto.getCantidadMaxima(), ldto.getCantidadMaxima());
	...
	public void updateProductoTest(){
		...
		Assert.assertEquals(ldto.getCantidadDisponible(), resp.getCantidadDisponible());	
		Assert.assertEquals(ldto.getCantidadEnProceso(), resp.getCantidadEnProceso());	
		Assert.assertEquals(ldto.getTiempoEspera(), resp.getTiempoEspera());	
		Assert.assertEquals(ldto.getCantidadMinima(), resp.getCantidadMinima());	
		Assert.assertEquals(ldto.getCantidadMaxima(), resp.getCantidadMaxima());	
	}
