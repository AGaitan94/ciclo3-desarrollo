...
public class ItemPersistenceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			entity.setFechaExp(generateRandom(Date.class));
	...
	public void createItemTest(){
		...
		dto.setFechaExp(generateRandom(Date.class));
		...
		Assert.assertEquals(dto.getFechaExp(), entity.getFechaExp());	
	...
	public void getItemTest(){
		...
		Assert.assertEquals(entity.getFechaExp(), dto.getFechaExp());
	...
	public void updateItemTest(){
		...
		Assert.assertEquals(dto.getFechaExp(), resp.getFechaExp());	
